...
//             <div>
//               <h2 className="font-semibold">RecipeHub(React)</h2>
...
//           <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
//             <div>
//               <h2 className="font-semibold text-sm">Ecommerce(MERN)</h2>
//               <p className="text-sm text-gray-700">Web Development</p>
//             </div>
//             <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
//               <img src={send_icon} alt="" className="w-5" />
...
//           <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
//             <div>
//               <h2 className="font-semibold">Portfolio(React)</h2>
//               <p className="text-sm text-gray-700">Web Development</p>
//             </div>
//             <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
//               <img src={send_icon} alt="" className="w-5" />
...
//                 Crypto Price Tracking App(React)
//               </h2>
//               <p className="text-sm text-gray-700">Web Development</p>
//             </div>
//             <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
  ...
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="grid grid-cols-auto my-10 gap-5 dark:text-black">
        ...
        {/* Link for Crypto Price Tracking App */}
        <a
        ...
        >
          <div className="aspect-square bg-[url('./assets/work-4.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
            <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              <div>
                <h2 className="font-semibold text-sm">
                  Crypto Price <br /> Tracking App(React)
                </h2>
                <p className="text-sm text-gray-700">Web Development</p>
              </div>
              <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
